...
if (($useRegion && $_SESSION['SOTBIT_REGIONS']['MAP_YANDEX']) || ($useRegion && $_SESSION['SOTBIT_REGIONS']['MAP_GOOGLE']) ) {
    if ($_SESSION['SOTBIT_REGIONS']['MAP_YANDEX']) {
        ...
        $position['yandex_scale'] = (int)$_SESSION['SOTBIT_REGIONS']['MAP_YANDEX']['START_SCALE'] ?? 10;
	...
	false
        ...
        $position['google_scale'] = (int)$_SESSION['SOTBIT_REGIONS']['MAP_GOOGLE']['START_SCALE'] ?? 14;
        $position['PLACEMARKS'] = array(
            array(
                'LON' => $google_lon,
                'LAT' => $google_lat,
...
<div class="contact-techno_block" id="contacts">
    <?$frame = $this->createFrame('contacts', false)->begin();?>
