...
if(!$USER->IsAuthorized())
{
    ...
    $APPLICATION->AddChainItem("Авторизация", "");
            ...
            $APPLICATION->IncludeComponent("bitrix:sale.personal.section", "ergopromo_orders", Array(
	"ACCOUNT_PAYMENT_ELIMINATED_PAY_SYSTEMS" => array(
		...
		"PATH_TO_BASKET" => Config::get("BASKET_PAGE"),	// Путь к корзине
		"PATH_TO_CATALOG" => "/catalog/",	// Путь к каталогу
		"PATH_TO_CONTACT" => "/about/contacts",	// Путь к странице контактных данных
		"PATH_TO_PAYMENT" => Config::get("PAYMENT_PAGE"),	// Путь к странице оплат
		"PER_PAGE" => "20",
		...
		"ORDER_DEFAULT_SORT" => "ID",	// Сортировка заказов
