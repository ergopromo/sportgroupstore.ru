        ...
        <div class="contact-info-box row bg-white mt-4 p-4 shadow-sm rounded">
            <div class="col-md-3 text-center mb-3 mb-md-0">
                <div>
                    ...
                    <div class="b-text fw-bold mt-2"><strong>Адрес:</strong></div>
            ...
            <div class="col-md-3 text-center mb-3 mb-md-0">
                <div>
                    <div style="font-size: 24px;">📞</div>
                    <div class="b-text fw-bold mt-2"><strong>Телефоны:</strong></div>
                    <div class="b-text">
            ...
            <div class="col-md-3 text-center mb-3 mb-md-0">
                <div>
                    ...
                    <div class="b-text fw-bold mt-2"><strong>E-mail:</strong></div>
                    <div class="b-text">
            ...
            <div class="col-md-3 text-center">
                <div>
                    <div style="font-size: 24px;">⏰</div>
                    <div class="b-text fw-bold mt-2"><strong>Режим работы:</strong></div>
