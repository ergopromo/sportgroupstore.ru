...
const CountBasket = (props) => {
    return <span id={`sotbit-side-panel-main__nav-count-basket`} className={`sotbit-side-panel-main__nav-count`}>
        {props.count}
    </span>
};
const CountDelay = (props) => {
    return <span id={`sotbit-side-panel-main__nav-count-delay`} className={`sotbit-side-panel-main__nav-count`}>
        {props.count}
    </span>
};
...
export default class Basket extends React.Component {
    ...
    constructor(props) {
        ...
        this.btnShowBasket = document.querySelector('.sotbit-side-panel-main__nav-item--cart');
        this.btnShowFavorite = document.querySelector('.sotbit-side-panel-main__nav-item--delay');
    ...
    render () {
        ...
        return (
          <div className={`basket`}>
              ...
              {ReactDOM.createPortal(<CountBasket count={this.state.countInBasket}/>, document.querySelector('.sotbit-side-panel-main__nav-item--cart'))}
              {ReactDOM.createPortal(<CountDelay count={this.state.countInDelay}/>, document.querySelector('.sotbit-side-panel-main__nav-item--delay'))}
          </div>
        );
    }
};
