...
if($arResult['CAN_CHANGE'] === true)
{
    ...
    Asset::getInstance()->addJs('/local/components/sotbit/origami.theme/templates/.default/scriptAdmin.js');
    Asset::getInstance()->addCss('/local/components/sotbit/origami.theme/templates/.default/styleAdmin.css');
...
//    $inlineFont = file_get_contents ('https://fonts.googleapis.com/css?family='.$curFont.':400,400i,600,700,800&display=swap');

//    echo '<style>' . $inlineFont . '</style>';
    Asset::getInstance()->addCss('https://fonts.googleapis.com/css?family='.$curFont.':400,400i,600,700,800&display=swap');
}
										...
										case 'ISELECT':
											...
											<div class="landing-ui-field landing-ui-field-button-group" data-selector="">
                                                ...
                                                <ul class="options-block options-block-iselect options-block__list" data-code="<?= $code ?>">
													...
													{
                                                        $arOrigamiTheme = [];
                                                        if(file_exists($_SERVER["DOCUMENT_ROOT"].$option['DIR'].'/'.strtolower($key)."/description.php")) {
