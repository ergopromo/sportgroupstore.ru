...
if($arResult['CAN_CHANGE'])
{
    ...
    Asset::getInstance()->addJs( '/local/components/sotbit/block.include/templates/.default/scriptAdmin.js');
    Asset::getInstance()->addCss('/local/components/sotbit/block.include/templates/.default/styleAdmin.css');
}
