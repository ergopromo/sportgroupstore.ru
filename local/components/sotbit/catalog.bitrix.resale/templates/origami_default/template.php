...
<div class="small-product-blocks">
    <?
    if (Option::get('SHOW_RECOMMENDATION_' . $arParams['TEMPLATE_NAMED'], SITE_ID) == 'Y') {
    ...
    if (Option::get('SHOW_BUY_WITH_' . $arParams['TEMPLATE_NAMED'], SITE_ID) == 'Y') {
        $productIds = [];
        $orders = [];
    ...
    if (Option::get('SHOW_BESTSELLER_' . $arParams['TEMPLATE_NAMED'], SITE_ID) == 'Y') {
        $productIds = [];
    ...
    if (Option::get('SHOW_VIEWED_' . $arParams['TEMPLATE_NAMED'], SITE_ID) == 'Y') {
        global $productFilter;
        $productFilter = ['ACTIVE' => 'Y'];
        $useRegion = (Config::get('USE_REGIONS', SITE_ID) == 'Y') ? true : false;
        if ($useRegion && $_SESSION['SOTBIT_REGIONS']['ID']) {
            $productFilter['PROPERTY_REGIONS'] = [
                false,
                $_SESSION['SOTBIT_REGIONS']['ID']
...
<?
?>
<?if(\Sotbit\Origami\Config\Option::get('SHOW_TABS_BITRIX_BLOCKS_' . $arParams['TEMPLATE_NAMED'], SITE_ID) == 'Y'):?>
    <script>
