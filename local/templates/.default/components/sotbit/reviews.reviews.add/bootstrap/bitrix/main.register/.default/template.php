...
<? $frame = $this->createFrame()->begin(); ?>
    <div class="bx-auth-reg">
        ...
        <? else: ?>
            ...
            <form method="post" action="javascript:void(null);" name="regform" id="registration_review"
                  enctype="multipart/form-data" data-params='<?= serialize($arParams) ?>'>
                ...
                <? foreach ($arResult["SHOW_FIELDS"] as $FIELD): ?>
                    ...
                    <? if ($FIELD != 'LOGIN'): ?>
                        <p><?= GetMessage("REGISTER_FIELD_" . $FIELD) ?>
				...
				<span class="bx-auth-secure" title="<? echo GetMessage("AUTH_NONSECURE_NOTE") ?>">
					<div class="bx-auth-secure-icon bx-auth-secure-unlock"></div>
                            ...
                            case "CONFIRM_PASSWORD":
                                ?><input size="30" type="password" name="REGISTER[<?= $FIELD ?>]"
                                         value="<?= $arResult["VALUES"][$FIELD] ?>" autocomplete="off" /><br><?
                                break;
                        ...
                        <input size="30" type="hidden" name="REGISTER[<?= $FIELD ?>]"
                            ...
                            default:
                                ...
                                ?><input size="30" type="text" name="REGISTER[<?= $FIELD ?>]"
                                         value="<?= $arResult["VALUES"][$FIELD] ?>" /><br><?
                ...
                if ($arResult["USE_CAPTCHA"] == "Y") {
                    ...
                    <div class="captcha">
                        ...
                        <p class="captcha-title-2"><?= GetMessage("REGISTER_CAPTCHA_PROMT") ?><span
                                class="starrequired">*</span></p>
