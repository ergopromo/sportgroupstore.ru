...
<div class="contact-phone__drop-down">
    ...
    <div class="contact-phone__drop-down-item">
        ...
        <p>
            <?=$arResult["FIELDS"]["UF_WORKING_MODE_SHORT"]['VALUE'] ?? '9:00 - 18:00'?>
        </p>
    </div>
    <div class="contact-phone__drop-down-item">
        <svg width="18" height="20">
    ...
    <?if(Config::get("HEADER_CALL") == "Y" && \Bitrix\Main\Loader::includeModule('sotbit.orderphone')):?>
        ...
        <a href="javascript:void(0)" class="contact-phone__drop-down-btn" onclick="callbackPhone('<?=SITE_DIR?>','<?=SITE_ID?>',this)">
