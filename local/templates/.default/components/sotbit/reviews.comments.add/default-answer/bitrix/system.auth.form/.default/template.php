...
<div class="bx-system-auth-form">
    ...
    <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top" action="javascript:void(null);"
          id="auth_comment">
        ...
        <div class="form-group">
            ...
            <input type="text" name="USER_LOGIN4" maxlength="50" value="<?= $arResult["USER_LOGIN"] ?>" size="17"/>
        </div>
        <div class="form-group">
            <p><?= GetMessage("AUTH_PASSWORD") ?>
        ...
        <? if ($arResult["STORE_PASSWORD"] == "Y"): ?>
            <div class="checkbox"><input type="checkbox" id="USER_REMEMBER_frm" name="USER_REMEMBER" value="Y"/><label
                    for="USER_REMEMBER_frm"
                    title="<?= GetMessage("AUTH_REMEMBER_ME") ?>"><span></span><? echo GetMessage("AUTH_REMEMBER_SHORT") ?>
                </label></div>
        ...
        <? endif ?>
        <button class="main_btn" type="submit" name="Login">
    ...
    <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top"
        ...
        <? if ($arResult["REMEMBER_OTP"] == "Y"): ?>
            ...
            <label for="OTP_REMEMBER_frm"
                   title="<? echo GetMessage("auth_form_comp_otp_remember_title") ?>"><span></span><? echo GetMessage("auth_form_comp_otp_remember") ?>
            </label>
