...
$this->addExternalCss(SITE_DIR . "local/templates/sotbit_origami/assets/css/filters/vertical/style.css");

$this->addExternalJs(SITE_DIR . "local/templates/sotbit_origami/assets/js/filters/vertical/script.js");
?>
            ...
            <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    if (isset($arItem["PRICE"])):
                        ...
                        ?>
                        <div class="bx_filter_parameters_box active" data-propid="P<?= $arItem["ID"] ?>" data-type="filter-parameters-box">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    if ($arItem["CODE"] == 'RAZMER'):?> filter-size<? endif ?>" data-propid="<?= $arItem["ID"] ?>" data-type="filter-parameters-box">
                        <span class="bx_filter_container_modef"></span>
                        <div class="bx_filter_parameters_box_title fonts__middle_text"
                             onclick="smartFilter.onClickFilterPropsTitle(this)">
                            <span>
                            ...
                            <div class="bx_filter_parameters_box_container">
                                ...
                                ?>
                                    <div class="bx-filter-param--checkbox-pict-label">
                                        <div class="bx-filter-param-btn-block sotbit-filter-props-wrap">
                                            <? foreach ($arItem["VALUES"] as $val => $ar):
                                                $ch++;
                                                ?>
                                                <div class="<?=($ch > $maxDisplay) ? 'hide-xl' :'' ?>"  data-type="filter-item">
                                                    <input
                                                            style="display: none"
                                                            type="checkbox"
                                                            name="<?= $ar["CONTROL_NAME"] ?>"
                                            ...
                                            <? endforeach ?>
                                            <div class="used-now-title main-mobile-filter-menu" data-type="usedNow" style=""><?= GetMessage('CT_BCSF_USED_NOW_TITLE') ?></div>
                                            <div class="not-used-now-title main-mobile-filter-menu" data-type="notUsed" style=""><?= GetMessage('CT_BCSF_NOT_USED_TITLE') ?></div>
                                        </div>
                                ...
                                ?>
                                    <div class="radio_container_wrapper">
                                        <div class="blank_ul_wrapper sotbit-filter-props-wrap">

                                            <? foreach ($arItem["VALUES"] as $val => $ar):
                                                $ch++; ?>
                                                <div class="radio_container <?=($ch > $maxDisplay) ? 'hide-xl' :'' ?>" data-type="filter-item">
                                                    <input
                                                            id="<?= $ar["CONTROL_ID"] ?>"
                                ...
                                ?>
                                    <div class="find_property_value_wrapper">
                                        <input type="text" class="find_property_value" placeholder="<?=GetMessage('CT_BCSF_FILTER_SELECT')?>" oninput="smartFilter.onFilterList(this)">
                                    ...
                                    <div class="blank_ul_wrapper type-checkbox sotbit-filter-props-wrap">
                                        <?foreach($arItem["VALUES"] as $val => $ar):
                                            $ch++;
                                            ?>
                                            <div class="bx_filter_parameters_box_checkbox <?=($ch > $maxDisplay) ? 'hide-xl' :'' ?>" data-type="filter-item">
                                                <input
                                                        type="checkbox"
