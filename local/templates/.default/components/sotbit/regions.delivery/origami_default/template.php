...
?>
<?
if($arParams['AJAX'] != 'Y' || $_REQUEST['bxajaxid'])
{
    ?>
        ...
        <div class="detailed-tabs__delivery-detail">
                <div class="detailed-tabs__delivery-region">
                    <p class="detailed-tabs__delivery-title">
                        ...
                        <?if(\Sotbit\Origami\Helper\Config::get('USE_REGIONS')=='Y'):?>
                ...
                <div class="detailed-tabs__delivery-way">
                    ...
                    <div class="detailed-tabs__delivery-way-wrapper">
                        ...
                        <script>
                            if (document.querySelector('.detailed-tabs__delivery-box')) {
                                new FixedBlock ('.detailed-tabs__delivery-box', {
                                    marginBottom: 35,
                                }).init();
                            }
                        </script>
            ...
            <?if(\Sotbit\Origami\Helper\Config::get('USE_REGIONS')=='Y'):?>
        <div class="select-city__modal-delivery" data-entity="modal">
            <div class="select-city__modal-wrap">
                ...
                <input class="select-city__input" type="region-input" id="region-input" data-entity="filter-regions">
                    ...
                    foreach ($arResult['REGION_LIST_COUNTRIES'] as $id => $region){
                        ...
                        <div class="select-city__tab_content <?=($id == key($arResult['REGION_LIST_COUNTRIES']))?'active':''?>" data-country-id="<?=$id?>" data-entity="tab-content">
                            <div class="select-city__list_wrapper">
                                ...
                                if($region['CITY']){
                                    ?>
                                    <div class="select-city__list_wrapper select-city__list_wrapper_cities_dilivery">
                                        <?
...
<?}?>
<script>
    var ajax = '<?= $_REQUEST['bxajaxid'] ? true : "" ?>';
