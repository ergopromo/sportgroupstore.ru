...
if($arResult['SAFE'])
{
    ...
    if(!empty($arResult['TOP_DESC'])){?>
        <div class="crosssell_collection_list-top-desc"><?= $arResult['TOP_DESC'] ?></div>
    <?}
    ...
    if(!empty($arResult['BOTTOM_DESC'])){?>
        <div class="crosssell_collection_list-bottom-desc"><?= $arResult['BOTTOM_DESC'] ?></div>
    <?}
}
