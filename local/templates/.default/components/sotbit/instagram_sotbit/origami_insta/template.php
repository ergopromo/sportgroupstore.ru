...
<div class="puzzle_block main-container">
    ...
    <div id="social_block_inst_<?=$idItem?>" class="social_block_inst instagram_youTube swiper-container">
        <div class="social_block_inst__wrapper swiper-wrapper">
            <?foreach(array_slice($arResult["POSTS"], 0, 4) as $key => $media):
                if($lazyLoad)
                {
                    $strLazyLoad = 'src="'.SITE_TEMPLATE_PATH.'/assets/img/loader_lazy.svg" data-src="'.$media["media_url"].'" class="lazy"';
                }else{
                    $strLazyLoad = 'src="'.$media["media_url"].'"';
                }
                ?>
                <div class="social_block_inst__item swiper-slide">
                    <div class="social_block_inst__img">
                        <a href="#link" target="_blank" class="social_block_inst__img_link">
