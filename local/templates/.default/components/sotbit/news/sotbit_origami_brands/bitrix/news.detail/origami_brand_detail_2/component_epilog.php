...
<div class="brand-detail-info <?= !is_array($arResult["DETAIL_PICTURE"]) ? 'without-banner' : '' ?> clearfix">
    ...
    <? if (!is_array($arResult["DETAIL_PICTURE"])) { ?>
        <div class="brand-detail-info__description-text"><?= $arResult['DETAIL_TEXT'] ?></div>
    <? } ?>
