	...
	<div class="block_main_left_menu">
        ...
        if($arParams['FILTER_VIEW_MODE'] == "VERTICAL")
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    "SHOW_SECTIONS" => "Y",
                    "AJAX_MODE" => ($arParams['AJAX_MODE'] == 'Y') ? "Y" : "N",
                    "INSTANT_RELOAD" => ($arParams['AJAX_MODE'] == 'Y') ? "Y" : "N",
                    "AJAX_OPTION_JUMP" => "N",
                    "AJAX_OPTION_HISTORY" => ($arParams['AJAX_MODE'] == 'Y') ? "Y" : "N",
		...
		<div class="block_main_left_menu__content active">
			...
			<div class="panel_filter_sort" id="component_sort">
                <?
                $componentSort = new Bitrix\Main\Composite\StaticArea('component_sort');
                $componentSort->startDynamicArea();
                ?>
				<div class="mobile_filter_btn" id="mobile_filter_btn" data-type="mobile_filter_btn" <?= $arParams['FILTER_VIEW_MODE'] == "VERTICAL" ? 'onclick="smartFilter.onToggleVisibility()"' : ''?>>
                ...
                <script>
                    function getTitles() {
                        let titles = [];
                        titles.push("<?= GetMessage("CT_BCSF_USED_NOW_TITLE") ?>");
                        titles.push("<?= GetMessage("CT_BCSF_NOT_USED_TITLE") ?>");
                        titles.push("<?= GetMessage("CT_BCSF_FILTER_SHOW_NEW") ?>");
                        titles.push("<?= GetMessage("CT_BCSF_FILTER_NUMBER1") ?>");
                        titles.push("<?= GetMessage("CT_BCSF_FILTER_NUMBER2") ?>");
                        titles.push("<?= GetMessage("CT_BCSF_FILTER_NUMBER3") ?>");
                        titles.push("<?= GetMessage("CT_BCSF_SET_FILTER") ?>");
                        return titles;
                    };
                </script>
                ...
                ?>
                <?
                $componentSort->finishDynamicArea();
                Bitrix\Main\Composite\BufferArea::addDynamicArea($componentSort);
                ?>
			</div>
			<?
