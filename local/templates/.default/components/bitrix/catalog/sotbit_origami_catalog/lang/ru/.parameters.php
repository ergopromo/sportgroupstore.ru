...
$MESS["CPT_BC_PRICES_VIEW"] = "Отображаемые типы цен";
...
$MESS['CP_BC_TPL_STORES_MAP'] = 'Карта складов';
...
$MESS['COMPLEX_ACTIVE'] = 'Комплексные отзывы';
$MESS['SHOW_REVIEWS'] = 'Показывать отзывы';
$MESS['SHOW_COMMENTS'] = 'Показывать комментарии';
$MESS['SHOW_QUESTIONS'] = 'Показывать вопросы';
$MESS['MAX_RATING'] = 'Максимальная оценка';
$MESS['COMMENTS_TEXTBOX_MAXLENGTH'] = 'Длина текстового поля комментария';
$MESS['QUESTIONS_TEXTBOX_MAXLENGTH'] = 'Длина текстового поля вопроса';
$MESS['REVIEWS_TEXTBOX_MAXLENGTH'] = 'Длина текстового поля отзыва';
$MESS['INIT_JQUERY'] = 'Подключить jquery';
