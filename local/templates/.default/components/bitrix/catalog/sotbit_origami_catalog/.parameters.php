...
$arTemplateParameters = array(
    ...
    "PRICES_VIEW" => array(
        ...
        "NAME" => GetMessage('CPT_BC_PRICES_VIEW'),
        "VALUES" => $arPrice,
        "TYPE" => "LIST",
        "MULTIPLE" => "Y",
        "DEFAULT" => "LIST",
    ...
    //Complex reviews params
    "COMPLEX_ACTIVE" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('COMPLEX_ACTIVE'),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "N",
    ),
    "SHOW_REVIEWS" => array(
    ...
    "SHOW_COMMENTS" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('SHOW_COMMENTS'),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "Y",
    ),
    "SHOW_QUESTIONS	" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('SHOW_QUESTIONS'),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "Y",
    ),
    "MAX_RATING" => array(
    ...
    "COMMENTS_TEXTBOX_MAXLENGTH" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('COMMENTS_TEXTBOX_MAXLENGTH'),
        "TYPE" => "STRING",
        "DEFAULT" => "200",
    ),
    "QUESTIONS_TEXTBOX_MAXLENGTH" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('QUESTIONS_TEXTBOX_MAXLENGTH'),
        "TYPE" => "STRING",
        "DEFAULT" => "200",
    ),
    "REVIEWS_TEXTBOX_MAXLENGTH" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('REVIEWS_TEXTBOX_MAXLENGTH'),
        "TYPE" => "STRING",
        "DEFAULT" => "200",
    ),
    "INIT_JQUERY" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('INIT_JQUERY'),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "N",
    ),
    "NOTICE_EMAIL" => array(
        "PARENT" => "COMPLEX_REVIEWS",
        "NAME" => GetMessage('NOTICE_EMAIL'),
        "TYPE" => "STRING",
        "DEFAULT" => "",
    ),
);
...
$arTemplateParameters['STORES_MAP'] = array(
    ...
    'NAME' => GetMessage('CP_BC_TPL_STORES_MAP'),
    'TYPE' => 'LIST',
    'DEFAULT' => 'YANDEX',
    'VALUES' => array(
        'GOOGLE' => 'Google Map',
