...
$this->addExternalJS("/local/templates/.default/components/bitrix/map.google.view/sotbit_regions_address/infobox/infobox.js");
...
else
{
	...
	<?
		for($i = 0; $i < $cnt; $i++):
	?>
	arr_placemark.push(BX_GMapAddPlacemark(<?echo CUtil::PhpToJsObject($arResult['POSITION']['PLACEMARKS'][$i])?>, '<?echo $arParams['MAP_ID']?>'));
	<?
		endfor;
	?>
	addEventOnMarkerGoogle(arr_placemark);
	}
