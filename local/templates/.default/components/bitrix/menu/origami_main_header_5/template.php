    ...
    <!--  -->
            <ul class="menu__nav menu-nav">
                ...
                <?if($USER->IsAuthorized()):?>
                    <li class="menu-nav__item">
                        <a class="menu-nav__item-link" href="?logout=yes&<?=bitrix_sessid_get()?>" title="<?=Loc::getMessage("SOTBIT_PERSONAL_LOGOUT")?>">
                            <div class="menu-nav__item-logo">
                                <svg class="menu-nav__item-logo-icon menu-nav__item-logo-icon--scale" width="24" height="24">
                                    <use xlink:href="/local/templates/sotbit_origami/assets/img/sprite.svg#icon_login"></use>
                                </svg>
                            </div>
                            <p class="menu-nav__item-title"><?=Loc::getMessage("SOTBIT_PERSONAL_LOGOUT")?></p>
                        </a>
                    </li>
                <?endif;?>
            </ul>
