    ...
    foreach($arResult as $arItem):?>
        ...
        <?if($arItem["IS_PARENT"]):?>
            <?if($arItem["DEPTH_LEVEL"] == 1):?>
                <li data-show-more class="visible-links__item <?if($arItem["SELECTED"]):?>active<?endif;?> <?if(isset($arItem["CHILD_SELECTED"])):?>current<?endif;?>">
                    <? if($arItem["LINK"] != $page): ?>
            ...
            <?else:?>
                <li data-show-menu class="category_link__active_content_item <?if($arItem["SELECTED"]):?>active<?endif;?> <?if(isset($arItem["CHILD_SELECTED"])):?>current<?endif;?>">
                    <? if($arItem["LINK"] != $page): ?>
