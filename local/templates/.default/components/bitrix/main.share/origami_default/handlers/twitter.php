...
if (
    ...
    $icon_url_template = "<script>\n" .
        ...
        "}\n" .
        "window.open('http://twitter.com/home/?status='+encodeURIComponent(shortUrl)+encodeURIComponent(' #PAGE_TITLE#'),'sharer', CenterShareDialog()); \n" .
        "}\n" .
        "</script>\n" .
    ...
    $icon_url_template = "<script>\n" .
        ...
        "function twitter_click_" . $arResult["COUNTER"] . "(longUrl) \n" .
        "{ \n" .
        "window.open('http://twitter.com/home/?status='+encodeURIComponent(longUrl)+encodeURIComponent(' #PAGE_TITLE#'),'sharer', CenterShareDialog()); \n" .
        "return false; \n" .
        "} \n" .
        "}\n" .
        "</script>\n" .
