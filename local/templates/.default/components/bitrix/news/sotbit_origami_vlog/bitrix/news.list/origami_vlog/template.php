...
$APPLICATION->SetTitle(Loc::getMessage('PAGE_TITLE_VLOG'));
                ...
                <div class="vlog__video-container video-container">
                    <a href="<?=$item['DETAIL_PAGE_URL']?>" class="video-container__image-wrapper">
                        ...
                        <div class="video-container__date">
                            ...
                            <span><?=FormatDate("Q", MakeTimeStamp($item['TIMESTAMP_X']))?> <?=Loc::getMessage('BACK')?></span>
                        </div>
                    </a>
                    ...
                    <div class="video-container__text-wrapper">
                        ...
                        <?if($item['TAGS']):?>
                            <div class="video-container__tags-wrapper video-tags">
                                <span class="video-tags__title"><?=Loc::getMessage('TAGS')?></span>
        ...
        <?if($arResult['ALL_TAGS']):?>
            <div class="vlog__sidebar-item">
                <div class="vlog__sidebar-item-title">
                    <span><?=Loc::getMessage('TAGS_V2')?></span>
                </div>
                ...
                <span class="vlog__sidebar-items-tags-show-all"><?=Loc::getMessage('GET_ALL')?></span>
            </div>
        <?endif;?>

        <div class="vlog__sidebar-item">
            <div class="vlog__sidebar-item-title">
                <span><?=Loc::getMessage('LAST_VIDEO')?></span>
            </div>
