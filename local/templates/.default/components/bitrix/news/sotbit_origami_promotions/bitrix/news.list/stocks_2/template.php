        ...
        <div class="stocks__content">
            <? foreach ($arResult["ITEMS"] as $i => $arItem):
                ...
                <div class="stocks__item-container item-container" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                    <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>" class="item-container__image-wrapper <?=$hoverClass?>" data-timer="timerID_<?= $blockID ?>">
                ...
                <? if (Config::get('TIMER_PROMOTIONS') == 'Y') {
                    ...
                    if (!empty($arItem["DATE_ACTIVE_TO"]) && $curTime < $arItem['DATE_ACTIVE_TO']) {
