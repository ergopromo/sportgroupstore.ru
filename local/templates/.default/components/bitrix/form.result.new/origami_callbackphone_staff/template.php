            ...
            foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion) {
                ...
                <div class="sotbit_order_phone__block">
                        ...
                        <?if($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'hidden'):?>
                            <input type="hidden"  name="form_<?= $fieldType ?>_<?= $arQuestion['STRUCTURE'][0]['ID'] ?>" value="<?= !empty($_REQUEST["staffName"]) ? $_REQUEST["staffName"] : $_REQUEST["form_".$fieldType."_".$arQuestion['STRUCTURE'][0]['ID']]?>" />
                            </div>
                            <?continue;?>
                        <?endif;?>
                        ...
                        <div class="main-input-md__wrapper <?= ($typeMask == 'N') ? 'fullsize' : ''; ?>">
                            <input
                                ...
                                <? else: ?>
                                    ...
                                    class="main-input-md <?= ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'date') ? 'filled' : '' ?>"
