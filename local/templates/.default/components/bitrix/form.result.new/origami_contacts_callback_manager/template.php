...
<script>
    function customCalendar(obj) {
        const value = BX.calendar(obj);
        value.DIV.parentNode.parentNode.style.zIndex = 1050;
    }
</script>
                        ...
                        <div class="main-input-md__wrapper <?= ($typeMask == 'N') ? 'fullsize' : ''; ?>">
                            ...
                            <input
                                ...
                                <? elseif ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'date'): ?>
                                    ...
                                    type="text"
                                    onclick="customCalendar({node: this, field: this, bTime: false})//BX.calendar({node: this, field: this, bTime: false});"
        ...
        BX.ready(function () {
            if (document.getElementById("number" + "<?= $arResult['arForm']['SID'] ?>")) {
                new BX.PhoneNumber.Input({
                    ...
                    flagSize: 16,
                    countryPopupClassName: 'callback-popup__select-country-manager',
                    defaultCountry: 'ru',
                    onChange: function (e) {
                    }
                });
