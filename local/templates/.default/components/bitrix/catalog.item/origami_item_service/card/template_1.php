    ...
    <div class="service-detail-item__content-hidden-wrapper">
        <div class="service-detail-item__content-hidden" data-entity="buttons-block">
            <div class="service-detail-item__content-hidden-form">
                <?php if($arParams['USE_PRODUCT_QUANTITY'] && $actualItem['CAN_BUY']): ?>
                ...
                if ($showSubscribe)
                {
                    $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            'BUTTON_CLASS' => 'service-detail-item__content-hidden-button main_btn',
                            'DEFAULT_DISPLAY' => !$actualItem['CAN_BUY'],
                            'MESS_BTN_SUBSCRIBE' => $arParams['~MESS_BTN_SUBSCRIBE'],
                            'MESS_SUBSCRIBE_POPUP_TITLE' => GetMessage('CPST_SUBSCRIBE_POPUP_TITLE'),
                        ),
                        $component,
                        array('HIDE_ICONS' => 'Y')
                    );
