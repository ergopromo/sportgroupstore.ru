...
<div class="product_card__inner <?=( $arParams['MOBILE_VIEW_MINIMAL'] == 'Y' ? "product_card__inner--min" : "" )?>">
    <div class="product_card__inner-wrapper">
        <a class="product-card-inner__stickers" href="<?=$item['DETAIL_PAGE_URL']?>" <?if($dbProductDiscounts): $blockID = randString(8);?> data-timer="timerID_<?=$blockID?>" <?endif;?>>
            <?
                ...
                <div class="product-card-inner__buy">
                    ...
                    if($arParams['USE_PRODUCT_QUANTITY'])
                    {
                        ...
                        <div class="product-card-inner__counter product-counter__amount" data-entity="quantity-block">
                            ...
                            <input type="number" id="<?=$itemIds['QUANTITY']?>" value="<?=$measureRatio?>">
