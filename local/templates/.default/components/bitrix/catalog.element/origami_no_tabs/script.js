...
document.addEventListener('DOMContentLoaded', ()=> {
    const sizeWrapper = document.querySelector('.detailed-tabs-list__size-wrapper');
    const tabList = sizeWrapper ? sizeWrapper.querySelector('.detailed-tabs-list') : null;
    const button = document.querySelector('.detailed-tabs-list__button');

    if (sizeWrapper && tabList && button) {
        if (sizeWrapper.clientHeight > 200) {
            button.style.display = 'flex';
            sizeWrapper.style.height = 200 + 'px';
        } else {
        ...
        button.addEventListener('click', () => {
            ...
            if (button.classList.contains('active')) {
                sizeWrapper.style.height = tabList.clientHeight + 'px';
            } else {
                sizeWrapper.style.height = 200 + 'px';
            }
        })
