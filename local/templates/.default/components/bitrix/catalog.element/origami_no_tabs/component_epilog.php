...
use Sotbit\Schemaorg\EventHandlers;
...
if (
    ...
    EventHandlers::makeContent($APPLICATION->GetCurPage(false), 'Product');
    ...
    if (!empty($data)) {
        foreach ($data as $k => &$dat) {
            if ($dat['@type'] == 'Product') {
                ...
                if (
                        !empty($arResult['PROPERTIES']['rating'])
                        && !empty($arResult['PROPERTIES']['rating']['VALUE'])
                ) {
...
if ($template == '.default') {
    $template = '';
} elseif ($template == 'origami_no_tabs') {
    $template = 'NO_TABS';
}
    ...
    if ($arParams['STORES'] && $arResult['OFFERS']) {
        ...
        while ($qnt = $rs->Fetch()) {
            ...
            if ($arParams['SHOW_MAX_QUANTITY'] == 'M') {
                ...
                if (
                        $qnt['AMOUNT'] / reset($offer['ITEM_MEASURE_RATIOS'])['RATIO']
                    ...
                    $qnt['AMOUNT'] = '<div class="product_card__block__presence_product_value_sufficient">' .
						...
						<span><svg class="product-card_icon-check" width="11px" height="12px">
                                        ...
                                        <div class="product-presence__img_and_buttom">
                                            ...
                                            if ($arResult['STORES'][$offer['ID']]) {
                                                ...
                                                <div class="product-presence__buttom">
                                                    <svg class="product-presence__buttom-icon"
                                                         width="14"
                                                         height="12">
                                        ...
                                        <div class="product-presence__offer-property">
                                            <div class="product-presence__name-block">
                                                <div class="product-presence__name">
                                                    ...
                                                    $name = $Offer->changeText($tmpResult,
                                                    ...
                                                    if ($arParams["FILL_ITEM_ALL_PRICES"] == "Y") {
                                                        ...
                                                        <div class="product_card__other_prices">
                                                            ...
                                                            foreach ($arResult['ALL_PRICES_NAMES'] as $priceId => $priceName) {
                                                                ?>
                                                                <div class="product_card__other_prices_row" <?= (!isset($offer['ITEM_ALL_PRICES'][$offer["ITEM_PRICE_SELECTED"]]["PRICES"][$priceId]['PRINT_PRICE'])) ? "style='display: none;'" : ""; ?> >
                                                                    ...
                                                                    <?
                                                                    if ($arParams['SHOW_OLD_PRICE'] === 'Y' && $offer['ITEM_ALL_PRICES'][$offer["ITEM_PRICE_SELECTED"]]["PRICES"][$priceId]["DISCOUNT"]) {
                                                                        ?>
                                                                    ...
                                                                    if ($arParams['SHOW_OLD_PRICE'] === 'Y' && $offer['ITEM_ALL_PRICES'][$offer["ITEM_PRICE_SELECTED"]]["PRICES"][$priceId]["DISCOUNT"] > 0) {
                                                                        ?>
                                                ...
                                                <? if ($arResult["SHOW_DELAY"] || $arResult["SHOW_COMPARE"]):?>
                                                    <div class="product-presence__icons">
                                                        ...
                                                        if ($arResult["SHOW_COMPARE"]) {
                                                            ?>
                                                            <span class="product-presence__icons-bar"
                                                                  data-entity="compare-checkbox-modification">
                                                <svg width="16"
                                                     height="16">
                                                ...
                                                <? if ($arResult["SHOW_BUY"]):?>
                                                    <div class="product-presence__basket">
                                                        <div class="product-detail-info-block-basket">
                                                            ...
                                                            if ($arParams['USE_PRODUCT_QUANTITY']
                                                                ...
                                                                <div class="product_card__block_buy_quantity product-detail-info-block-basket-item">
                                                                    <span class="product_card__block_buy_quantity__minus fonts__small_title"
                                                                          data-entity="modification-minus">&#8722;</span>
                                                                    ...
                                                                    <span class="product_card__block_buy_quantity__plus fonts__small_title"
                                                                          data-entity="modification-plus">+</span>
                                                                </div>
                                                            <? }
                                                            if ($offer['CAN_BUY'] == 'Y') {
                                                                ?>
                                                                <div class="detail-basket-wrapper product-detail-info-block-basket-item">
                                                                    ...
                                                                    if ($showAddBtn) {
                                                                        ...
                                                                        <a class="main_btn sweep-to-right"
                                                                           data-entity="modification-addbasket"
                                                                    ...
                                                                    if ($showBuyBtn) {
                                                                        ?>
                                                                        <a class="main_btn sweep-to-right"
                                                                           data-entity="modification-buybasket"
                                                                           href="javascript:void(0);"> <?= Loc::getMessage('CT_BCE_CATALOG_ADD') ?>
                                                                        </a>
                                                                        <?
                                                                    }
                                                            ...
                                                            <? if ($offer['CAN_BUY'] && Config::get('SHOW_BUY_OC') == 'Y' && Loader::includeModule('sotbit.orderphone')): ?>
                                                                <div
                                                        ...
                                                        if ($store['UF_METRO']) {
                                                            ...
                                                            <div class="product-presence__address-metro">
                                                                <svg version="1.1"
                                                                     ...
                                                                     style="enable-background:new 0 0 95.44 95.441;"
                                                                     xml:space="preserve">
                                                <g>
                                                    <g>
    ...
    <div id="element_tab_available_content"
        ...
        if (Config::get('ACTIVE_TAB_AVAILABLE_' . $template) == 'Y') {         //<===HARD
            ...
            if (CCatalogSKU::IsExistOffers($arResult['ID'],
                $arResult['IBLOCK_ID'])) {
                $arItemsSKU = CCatalogSKU::getOffersList([$arResult['ID']],
                    $arResult['IBLOCK_ID'],
                    array(),
                    array());
                foreach ($arItemsSKU[$arResult['ID']] as $item) {
                    $dbItem = CCatalogStoreProduct::GetList(array(),
                        [
                            'PRODUCT_ID' => $item,
                            'STORE_ID' => $arParams['STORES']
                        ],
            ...
            if($arItems) {
                ...
                <div class="availability-item"
                     data-id="<?= $qnt['PRODUCT_ID'] ?>">
                    <? if ($store['IMAGE']['src']): ?>
                        <div class="availability-item__img-wrapper">
                            <img src="<?= $store['IMAGE']['src'] ?>"
                                 alt="<?= $store['IMAGE']['src'] ?>"
                                 title="<?= $store['IMAGE']['src'] ?>">
                        </div>
                    <?endif; ?>
                    <div class="availability-item__content-tile-wrapper availability-item__content-tile-wrapper--tablet">
                        ...
                        <a href="#map-test"
                           class="availability-item__content-link-map">
                            <svg class="availability-item__content-link-icon"
                                 width="18"
                                 height="18">
...
if (isset($templateData['JS_OBJ'])) {
    ...
    if ($offerId > 0 && !empty($templateData['OFFER_IDS']) && is_array($templateData['OFFER_IDS'])) {
        $offerNum = array_search($offerId,
            $templateData['OFFER_IDS']);
    } elseif (!empty($offerCode) && !empty($templateData['OFFER_CODES']) && is_array($templateData['OFFER_CODES'])) {
        $offerNum = array_search($offerCode,
            $templateData['OFFER_CODES']);
    }
...
?>
    <div id="element_advantages_content"
         style="display:none;">
        <?php
        $APPLICATION->IncludeComponent(
            "bitrix:news.list",
...
if (Bitrix\Main\Loader::includeModule('sotbit.opengraph')) {
    if (!empty($templateData["ITEM"]["JS_OFFERS"][0]["DETAIL_PICTURE"]["SRC"])) {
        OpengraphMain::setImageMeta('og:image',
            $templateData["ITEM"]["JS_OFFERS"][0]["DETAIL_PICTURE"]["SRC"]);
        OpengraphMain::setImageMeta('twitter:image',
            $templateData["ITEM"]["JS_OFFERS"][0]["DETAIL_PICTURE"]["SRC"]);
    }

    OpengraphMain::setMeta('og:type',
        'product');
    OpengraphMain::setMeta('og:title',
        $arResult["NAME"]);
    OpengraphMain::setMeta('og:description',
        $arResult["META_TAGS"]["DESCRIPTION"]);
    OpengraphMain::setMeta('twitter:title',
        $arResult["NAME"]);
    OpengraphMain::setMeta('twitter:description',
        $arResult["META_TAGS"]["DESCRIPTION"]);
}
