				...
				elseif($qnt['AMOUNT']/reset($offer['ITEM_MEASURE_RATIOS'])['RATIO']<$arParams['RELATIVE_QUANTITY_FACTOR'])
				{
	                $qnt['AMOUNT'] = '<div class="product_card__block__presence_product_value_sufficient">'.
						...
						<span><svg class="product-card_icon-check" width="11px" height="12px">
                                                                ...
                                                                </svg> '.\Bitrix\Main\Localization\Loc::getMessage('CT_BCE_CATALOG_RELATIVE_QUANTITY_FEW').'</span>
					</div>';
				}
				else{
                            ...
                            <div class="product-presence__action">
                                ...
                                <div class="product-presence__basket">
                                    <div class="product-detail-info-block-basket">
                                        ...
                                        <? if ($offer['CAN_BUY'] && Config::get('SHOW_BUY_OC') == 'Y' && \Bitrix\Main\Loader::includeModule('sotbit.orderphone')): ?>
                                                <div
