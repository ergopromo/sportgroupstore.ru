...
if (\Bitrix\Main\Loader::includeModule('sotbit.reviews') && Option::get('ACTIVE_TAB_COMPLEX_REVIEWS_', SITE_ID) === 'Y') {
    $votesValue = CSotbitReviews::getReviewByItemId($arParams['ELEMENT_ID']);
    $votes = new CSotbitReviews();
    $votes->setReviewsCnt($arParams['ELEMENT_ID'], $arParams['MAX_VOTE'], SITE_ID);
    $votesCount = CSotbitReviews::getReviewsCnt()['SUM_CNT_REVIEWS'];
}
