	...
	<div class="info_order_item">
        ...
        <div class="info_order_item_content">
            ...
            <div class="radio_container">
                <div class="main_checkbox" onclick="changePaySystem('account');" >
                    ...
                    <label for="PAY_CURRENT_ACCOUNT" id="PAY_CURRENT_ACCOUNT_LABEL" class="<?if($arResult["USER_VALS"]["PAY_CURRENT_ACCOUNT"]=="Y") echo "selected"?> radio-label fonts__main_comment">
                        <span></span>
