...
(function() {
    ...
    BX.Sale.OrderAjaxComponent = {
        ...
        init: function(parameters)
        {
            ...
            this.siteDir = parameters.siteDir || '';
            ...
            authFormNode = BX.create('DIV', {
                ...
                children: [
                    ...
                    BX.create('A', {
                        ...
                        events: {
                            click: () => {
                                window.top.location = window.top.location.origin + '/personal/' + '?forgot_password=yes&back_url=' + encodeURIComponent(document.location.href);
                            },
                        },
        ...
        editRegistrationForm: function(authContent)
        {
            ...
            else
            {
                            ...
                            children: [
                                BX.create('INPUT', {
                                    attrs: {
                                        ...
                                        'onload': 'isInputFilled(this)',
                                        'required': setRequiredArrt.call(this),
                                        'id': 'checkout-STOF_PHONE'
                                    },
                                    props: {
                                        name: 'PHONE_NUMBER',
                                        type: 'text',
                                        size: 40,
                                        className: 'main-input-md main-input-bg--gray masked-phone' + ' ' + this.isAuthFormInputFilled.call(this, 'PHONE_NUMBER'),
                                        value: this.result.AUTH.PHONE_NUMBER || ''
                                    },
                                    events: {
                                        keypress: BX.proxy(this.checkKeyPress, this),
                                        // onload: BX.proxy(this.checkKeyPress, this)
                                    }
                                }),
                                BX.create('LABEL', {
                                    attrs: {
                                        'for': 'checkout-STOF_PHONE',
                                    },
                                    props: {
                                        className: 'main-label-md',
                                    },
                                    html: BX.message('STOF_PHONE') + isPhoneRequired.call(this)
                                }),
                            ]
                        }),
                ...
                function isPhoneRequired() {
                    return this.result.AUTH.new_user_phone_required === 'Y'
                        ? '*'
                        : ''
                }
                            ...
                            this.createAuthFormInputContainer(
                                ...
                                BX.create('DIV', {
                                    ...
                                    children: [
                                        ...
                                        BX.create('LABEL', {
                                            attrs: {
                                                'for': 'checkout-STOF_NEW_PASSWORD',
                                            },
                                            props: {
                                                className: 'main-label-md',
                                            },
                    ...
                    authFormNodes.push(BX.create('DIV', {
                        ...
                        children: [
                            BX.create('DIV', {
                                ...
                                children: [
                                    BX.create('DIV', {
                                        props: {className: 'bx-captcha feedback_block__captcha'},
                                        children: [
                                            BX.create('INPUT', {
                                                props: {
                                                    name: 'captcha_sid',
        ...
        getDeliveryLocationInput: function(node)
        {
            var currentProperty, locationId, altId, location, k, altProperty,
                ...
                labelTextHtml, label, input, altNode, sotbitWrapper;
            ...
            if (altProperty)
            {
                ...
                sotbitWrapper = BX.create('DIV', {
                    props: {className: "sotbit-wrapper"},
                    children: [input],
                });
                ...
                //==== fix tollTip ====
                altNode.appendChild(label);
                altNode.appendChild(sotbitWrapper);
                node.appendChild(altNode);
        ...
        {
            var zipProperty, i, propsItemNode, labelTextHtml, label, input, sotbitWrapper;
            ...
            if (zipProperty)
            {
                ...
                propsItemNode.appendChild(label);
                propsItemNode.appendChild(sotbitWrapper);
                node.appendChild(propsItemNode);
        ...
        getDeliveryPriceNodes: function(delivery)
        {
            ...
            {
                if(this.params.DELIVERY_LIST !== 'undefined' && this.params.DELIVERY_LIST.includes(delivery.ID)) {
                    priceNodesArray = [BX.message('DELIVERY_MESSAGE_PRICE')];
                } else {
        ...
        createDeliveryItem: function(item)
        {
            ...
            {
                if(this.params.DELIVERY_LIST === 'undefined' || !this.params.DELIVERY_LIST.includes(item.ID)) {
                    labelNodes.push(
                        BX.create('DIV', {
        ...
        {
            var prop, inputs, values, i, propContainer, sotbitWrapper;
        ...
        showErrorTooltip: function(tooltipId, targetNode, text)
        {
            ...
            var tooltip = BX('tooltip-' + tooltipId),
                tooltipInner, quickLocation, wrapper;
            ...
            else
            {
                ...
                //====== fix tooltip========
                wrapper = targetNode.parentNode.querySelector('div.sotbit-wrapper');
                ...
                if (wrapper) {
                    targetNode = wrapper;
                    targetNode.insertAdjacentElement('afterbegin', tooltip);
                } else {
                    BX.insertAfter(tooltip, targetNode);
                };
        ...
        {
            var propsCommentContainer, label, input, div, sotbitWrapper;
        ...
        editTotalBlock: function()
        {
            ...
            else
            {
                ...
                {
                    if(this.params.DELIVERY_LIST !== 'undefined' && this.params.DELIVERY_LIST.includes(curDelivery.ID)) {
                        deliveryValue = BX.message('DELIVERY_MESSAGE_PRICE');
                    } else {
