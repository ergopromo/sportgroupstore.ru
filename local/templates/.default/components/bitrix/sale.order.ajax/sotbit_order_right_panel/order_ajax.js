	...
	BX.Sale.OrderAjaxComponent = {
				...
				buttons.push(
					BX.create('A', {
						props: {
							...
							className: 'pull-left btn btn-default btn-md 1364646'
						},
		...
		createPaySystemItem: function(item)
		{
			...
			itemNode = BX.create('DIV', {
				props: {className: 'bx-soa-pp-company col-lg-4 col-xs-4 col-6'},
		...
		editPaySystemInfo: function(paySystemNode)
		{
			...
			var paySystemInfoContainer = BX.create('DIV', {
					props: {
						className: (this.result.PAY_SYSTEM.length == 0 ? 'col-xs-12' : 'col-xs-5') + ' bx-soa-pp-desc-container'
					}
				}),
		...
		editDeliveryItems: function(deliveryNode)
		{
			...
			var deliveryItemsContainer = BX.create('DIV', {props: {className: 'col-xs-7 bx-soa-pp-item-container row'}}),
				deliveryItemNode, k;
		...
		editDeliveryInfo: function(deliveryNode)
		{
			...
			var deliveryInfoContainer = BX.create('DIV', {props: {className: 'col-xs-5 bx-soa-pp-desc-container'}}),
		...
		editPropsItems: function(propsNode)
		{
			...
			var propsItemsContainer = BX.create('DIV', {props: {className: 'col-xs-12 bx-soa-customer'}}),
				group, property, groupIterator = this.propertyCollection.getGroupIterator(), propsIterator;

			if (!propsItemsContainer)
				propsItemsContainer = this.propsBlockNode.querySelector('.col-xs-12.bx-soa-customer');
		...
		{
			var propsMapContainer = BX.create('DIV', {props: {className: 'col-xs-12'}, style: {marginBottom: '10px'}}),
		...
		editPropsComment: function(propsNode)
		{
			...
			propsCommentContainer = BX.create('DIV', {props: {className: 'col-xs-12'}});
			label = BX.create('LABEL', {
