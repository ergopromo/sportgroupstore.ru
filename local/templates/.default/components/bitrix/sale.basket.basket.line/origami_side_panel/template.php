...
<div class="side-panel">
    <div class="side-panel__nav">
        ...
        <?if (!$USER->IsAuthorized()):?>
            <a href="<?=\Sotbit\Origami\Helper\Config::get('PERSONAL_PAGE')?>" class="side-panel-main__nav-item side-panel-main__nav-item--login" id="right_auth"
        ...
        <?else:?>
            <a href="<?=\Sotbit\Origami\Helper\Config::get('PERSONAL_PAGE')?>" class="side-panel-main__nav-item side-panel-main__nav-item--auth" id="right_auth">
                <svg width="18" height="20">
