...
$generalParams = array(
    ...
    '~COMPARE_URL_TEMPLATE' => str_replace('/bitrix/components/sotbit/crosssell.collection/ajax.php',
        '',
        $arResult['~COMPARE_URL_TEMPLATE']),
    '~COMPARE_DELETE_URL_TEMPLATE' => str_replace('/bitrix/components/sotbit/crosssell.collection/ajax.php',
        '',
        $arResult['~COMPARE_DELETE_URL_TEMPLATE']),
...
$sliderButtons = "";
if (Config::get('SLIDER_BUTTONS') == 'square') {
    $sliderButtons = "btn-slider-main--one";
} elseif (Config::get('SLIDER_BUTTONS') == 'circle') {
