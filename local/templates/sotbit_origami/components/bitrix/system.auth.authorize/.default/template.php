...
$this->addExternalCss(SITE_DIR . "local/templates/sotbit_origami/components/bitrix/system.auth.authorize/.default/style.css");
if (mb_strtolower(SITE_CHARSET) == 'windows-1251') {
    array_walk_recursive(
        $arResult,
        function(&$val) { $val = Encoding::convertEncodingToCurrent($val); },
    );
}
?>
<? if ($_REQUEST['ajax_mode'] == "Y"): ?>
	...
	<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
		...
		<div class="bx-authform-formgroup-container">
			<div class="bx-authform-input-container main-input-bg__wrapper">
                ...
                <? endif; ?>
				<input id="USER_PASSWORD" type="password" name="USER_PASSWORD" maxlength="255" autocomplete="off" class="main-input-bg main-input-bg--gray" onblur="isInputFilled(this)"  onchange="isInputFilled(this)" />
