            ...
            <div class='modal-block-inner'>
                <div id="<?=$cartId?>products" class="bx-basket-item-list-container open-basket-origami-container modal-content ">
                    ...
                    <div class="open-basket-origami">
                        <h2 class="open-basket-origami__title"><?=GetMessage("ORIGAMI_BASKET_BASKET")?></h2>
                                                ...
                                                <div class="open-basket-product-block__item open-basket-product__number">
                                                    <div class="open-basket-product__quantity">
                                                        <div class="open-basket-product__quantity-minus" onclick="<?=$cartId?>.refreshMinusCart(<?=$arCart['ID']?>, <?=$arCart['RATIO']?>, <?=$arCart['PRODUCT_ID']?>, this)">
                                                            <svg class="open-basket-product__quantity-minus-icon" width="10" height="10">
                                                                <use xlink:href="/local/templates/sotbit_origami/assets/img/sprite.svg#icon_minus"></use>
                                                            </svg>
                                                        </div>
                                                        ...
                                                        <div class="open-basket-product__quantity-plus"
                                                            ...
                                                            <?endif;?>
                                                            ">
                                                            <svg class="open-basket-product__quantity-plus-icon" width="10" height="10">
                                                                <use xlink:href="/local/templates/sotbit_origami/assets/img/sprite.svg#icon_plus"></use>
                                                            </svg>
                                                        </div>
                                                    </div>
...
<!--                                    </a>-->
                                    ...
                                    ?>
                                    <? if(\Bitrix\Main\Loader::includeModule('sotbit.orderphone') && Config::get("SHOW_BUY_OC") === 'Y' ): ?>
                                        <button
