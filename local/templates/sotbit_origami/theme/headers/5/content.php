...
?>
<div class="header-three <?= $headerBgColor ?>"
     id="header-three">
        ...
        <div class="header-three__city"
            ...
            <style>
                .select-city__block__text-city {
                    color: <?=
                        $headerBgColor === 'header-three--gray' ? '#484848'
                        : ($headerBgColor === 'header-three--black' ? '#bdbdbd' : '#898989')
                    ?>
                }
            </style>
            <?
        ...
        <div class="header-three__search">
            ...
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "CONTAINER_ID" => "search",
                    "PRICE_CODE" => \SotbitOrigami::GetComponentPrices([
                        "BASE",
                        "OPT",
                        "SMALL_OPT"
                    ]),
	...
	false
                ...
                <div class="contact-phone__link">
                    ...
                    ?>
                    <svg class="contact-phone__arrow-icon"
                         width="10"
                         height="6">
        ...
        <div class="header-three__personal <?= (Config::get('BASKET_TYPE') == 'origami_top_without_basket') ? "right-panel--show" : ""; ?>">
            ...
            <style>
                ...
                .header-three__personal-link:hover span{
                    color: var(--main-color);
                }
            </style>
            <? if ($USER->IsAuthorized()): ?>
                <a class="header-three__personal-link"
                   href="<?= Config::get('PERSONAL_PAGE') ?>">
