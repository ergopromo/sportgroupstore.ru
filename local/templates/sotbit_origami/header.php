...
if (isset($_REQUEST['q']))
    if (iconv(mb_detect_encoding($_REQUEST['q']), SITE_CHARSET, $_REQUEST['q']))
        $_REQUEST['q'] = iconv(mb_detect_encoding($_REQUEST['q']), SITE_CHARSET, $_REQUEST['q']);
...
//  for phone validation
    ...
    Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/assets/css/style-icons.min.css");
    Asset::getInstance()->addCss("https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css");
