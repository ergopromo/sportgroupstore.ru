        ...
        if (!insertFilter) {
            ...
            function setMobileFilterEvents() {
                ...
                function displayApplyNumber() {
                    if (mql.matches) {
                        let modNumber = parseInt(document.getElementById("modef_num_btn").textContent),
                            filterContainer = document.querySelector(".bx_filter__container"),
                        ...
                        if (isSomeItemSelected(filterItems)) {
                            ...
                            filterContainer.style.height = "calc(100% - 90px)";
                ...
                function setEventListeners() {
                    ...
                    bxFilterSection.addEventListener("click", () => {
                            if (mql.matches) {
                                sortFilterMainMenuItems();
                                displayApplyNumber();
                            }
...
const init = function (ajax = 'N') {
    ...
    $(".mobile_filter_form").on("click", ".properties_block_title", function () {
        $(this).parent().hide("slide", {direction: "right"}, function () {
            ...
            let bxFilter = $('.bx_filter');
            let filterContainerMobileShow =  bxFilter.find(".mobile-show[data-role='bx_filter_block']");
            if(filterContainerMobileShow){
                filterContainerMobileShow.removeClass('mobile-show');
            }
        });
    });
