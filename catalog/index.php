...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_USE_VOTE_RATING" => Config::get("SHOW_VOTE_RATING"),
		"DETAIL_VK_USE" => "N",
		...
		"FILTER_NAME" => "",
		"FILTER_VIEW_MODE" => Config::get("FILTER_TEMPLATE"),
		...
		"PRICE_CODE" => \SotbitOrigami::GetComponentPrices(["Для покупателей из интернет-магазина"]),
		"PRICE_VAT_INCLUDE" => "Y",
